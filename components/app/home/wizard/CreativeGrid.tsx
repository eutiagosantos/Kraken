        ...
        <article key={creative.id} className="group overflow-hidden rounded-lg border border-gray-200 bg-white">
          <div className="flex flex-col sm:flex-row">
            ...
            <div className="min-w-0 flex-1 p-3">
              ...
              <p className="mb-2 text-[11px] text-gray-500">{formatSize(creative.size)}</p>
              <label className="block text-[11px] font-medium text-gray-700" htmlFor={`creative-copy-${creative.id}`}>
                Texto do anúncio
              </label>
              <textarea
                ...
                rows={4}
                placeholder="Opcional — se ficar vazio, usa-se o nome do ficheiro no Meta."
