...
export function StatCard({
  ...
  return (
    <div className="flex gap-3.5 rounded-xl border border-dashboard-border bg-dashboard-surface p-5">
      <div
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-0.5 font-display text-display-md text-neutral-black max-md:text-xl">{value}</p>
        <p
          className={cn(
