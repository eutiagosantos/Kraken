import { campanhaStructureDisplay } from "@/libs/campanhas-structure";
import type { Campanha, CampanhaCreative, CampanhaError, CampanhaStatus } from "@/libs/mock-campanhas";
