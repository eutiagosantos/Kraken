...
import type { MetaAdAccountRow } from "@/libs/database/queries/meta-ad-accounts";
import type { UploadJobRow } from "@/libs/database/queries/upload-jobs";

type Tables = Database["public"]["Tables"];

export type HomeDashboardRows = {
  kpis: Tables["home_kpis"]["Row"][];
  uploads: UploadJobRow[];
  activities: Tables["activity_events"]["Row"][];
  creatives: Tables["creative_library_items"]["Row"][];
};

export type ContasMetaListRows = MetaAdAccountRow[];
