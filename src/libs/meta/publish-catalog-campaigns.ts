import { insertCampanhaReturningId } from "@/libs/database/queries/campanhas";
import { buildCatalogDpaObjectStorySpec } from "@/libs/meta/catalog-ad-creative";
import type { CatalogPublishPayload } from "@/libs/meta/catalog-publish-payload";
import {
  assertCatalogAndProductSet,
  assertPixelOnAdAccount,
  buildCatalogPromotedObject,
} from "@/libs/meta/catalog-promoted-object";
import {
